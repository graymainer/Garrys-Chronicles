--[[ from the gunman.fgd file, here is the definition of this entity for hammer.
	...
	input setSound(integer)				: "Will change the sound to play to whatever you give us."
	...
	output onMilestone(void)			: "Fired when this counter reaches the next milestone. \n" + "By default, a milestone is reached by every 10."
...
function ENT:Initialize() --self is only valid within this scope.
	...
	self:SetModel(model) --start rendering our model
